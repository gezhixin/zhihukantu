...
open class Popover: UIView {
  ...
  fileprivate var sideEdge: CGFloat = 20.0
  fileprivate var offset: CGFloat = 0.0
  fileprivate var popoverType: PopoverType = .down
  fileprivate var blackOverlayColor: UIColor = UIColor(white: 0.0, alpha: 0.2)
  fileprivate var popoverColor: UIColor = UIColor.white
  ...
  open func show(_ contentView: UIView, fromView: UIView) {
    ...
    switch self.popoverType {
    case .up:
      point = CGPoint(x: fromView.frame.origin.x + (fromView.frame.size.width / 2), y: fromView.frame.origin.y + offset)
    case .down:
      point = CGPoint(x: fromView.frame.origin.x + (fromView.frame.size.width / 2), y: fromView.frame.origin.y + fromView.frame.size.height - 3 + offset)
    }
  ...
  override open func draw(_ rect: CGRect) {
    ...
    case .up:
      ...
      arrow.addArc(withCenter: CGPoint(x: self.cornerRadius, y: self.bounds.height - self.arrowSize.height - self.cornerRadius),
      ...
      arrow.addArc(withCenter: CGPoint(x: self.cornerRadius, y: self.cornerRadius),
        radius: self.cornerRadius,
      ...
      arrow.addArc(withCenter: CGPoint(x: self.bounds.width - self.cornerRadius, y: self.cornerRadius),
        radius: self.cornerRadius,
      ...
      arrow.addArc(withCenter: CGPoint(x: self.bounds.width - self.cornerRadius, y: self.bounds.height - self.arrowSize.height - self.cornerRadius),
        radius: self.cornerRadius,
    ...
    case .down:
      ...
      arrow.addArc(withCenter: CGPoint(x: self.bounds.width - self.cornerRadius, y: self.bounds.height - self.cornerRadius),
        radius: self.cornerRadius,
        startAngle: self.radians(0),
        endAngle: self.radians(90),
        clockwise: true)
      ...
      arrow.addArc(withCenter: CGPoint(x: self.cornerRadius, y: self.bounds.height - self.cornerRadius),
        radius: self.cornerRadius,
        startAngle: self.radians(90),
        endAngle: self.radians(180),
        clockwise: true)
      ...
      arrow.addArc(withCenter: CGPoint(x: self.cornerRadius, y: self.arrowSize.height + self.cornerRadius),
        radius: self.cornerRadius,
        startAngle: self.radians(180),
        endAngle: self.radians(270),
        clockwise: true)
